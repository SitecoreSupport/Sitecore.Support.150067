...
{
    [SitecoreAuthorize(new string[] { @"sitecore\ECM Advanced Users", @"sitecore\ECM Users" }), ServicesController("EXM.CustomRecipientLists")]
    public class CustomRecipientListsController : ServicesApiController
    {
        ...
        public Response RecipientLists(RecipientListDataSourceContext data)
        {
            ...
            try
            {
                ...
                ListManager<Sitecore.ListManagement.ContentSearch.Model.ContactList, ContactData> manager = Factory.CreateObject("contactListManager", false) as ListManager<Sitecore.ListManagement.ContentSearch.Model.ContactList, ContactData>;
                ...
                foreach (RecipientList list2 in response.RecipientLists)
                {
                    ...
                    {
                        Sitecore.ListManagement.ContentSearch.Model.ContactList list3 = manager.FindById(list2.Id);
